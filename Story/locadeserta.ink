...
{ Property has horse: Недалеко від'їжджає, коли помічає, що кінь ушкодив ногу.}
{ Property hasnt horse: Недалеко відходить, коли здалеку бачить куряву і чує звуки бою}
