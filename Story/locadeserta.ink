...
LIST Inventory = (knife), bow, sword, hat, coat, cup, firesteel, nice_sheath, horse, flask, boat
...
=== surrounded
    Дмитро виявляє, що оточений татарами. Вони починають шукати його в лісі. Можуть взяти в полон - можливо, відіб'ють рибалки.
    // Debug
...
=== shoot
    ...
    ~ Inventory += (horse, hat, coat, sword)
