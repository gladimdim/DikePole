...
//                               ),
//                               Image(
//                                 image: AssetImage(data.item2),
//                               ),
//                               LinearProgressIndicator(
//                                 value: data.item1,
//                                 semanticsValue: data.item1.toString(),
//                               ),
//                             ],
//                           ),
//                         ),
...
//   ExportPdfViewArguments(
//       {required this.catalogStory, required this.storyHistory});
// }
...
//         ModalRoute.of(context)!.settings.arguments as ExportPdfViewArguments;
...
//   ExportGladStoriesPdfViewArguments({required this.story});
// }
...
//   Widget build(BuildContext context) {
//     final ExportGladStoriesPdfViewArguments args = ModalRoute.of(context)!
//         .settings
//         .arguments as ExportGladStoriesPdfViewArguments;
...
//   final Story story;
//   late PdfGladStoriesCreator creator;

//   ExportGladStoriesToPDF({required this.story}) {
