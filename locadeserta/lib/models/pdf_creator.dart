...
//       StreamController<Tuple2<double, String>>();
//   late Stream<Tuple2<double, String>> decodeProgress;

//   PdfCreator({required this.story}) {
...
//     var counter = 0.0;
//     var futuresCompleted =
//         await Future.forEach<HistoryItemBase>(imageItems, ((imageItem) async {
...
//   PdfGladStoriesCreator({required this.story}) {
//     decodeProgress = _decodeProgress.stream;
//   }
...
//     var counter = 0.0;
//     var futuresCompleted =
//         await Future.forEach(imageItems, ((HistoryItem imageItem) async {
