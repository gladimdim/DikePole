      ...
      children: [
        ...
        Row(
          children: <Widget>[
            ...
            if (isLarge) Text("Українською", style: TextStyle(color: Theme.of(context).accentColor)),
          ],
        ),
        Radio(
          value: 'pl',
        ...
        Row(
          children: <Widget>[
            Text('🇵🇱', style: TextStyle(fontSize: 24)),
            if (isLarge) Text("Polski", style: TextStyle(color: Theme.of(context).accentColor))
          ],
        ),
        Radio(
          value: 'en',
        ...
        Row(
          children: <Widget>[
            Text('🇺🇸', style: TextStyle(fontSize: 24)),
            if (isLarge) Text("English", style: TextStyle(color: Theme.of(context).accentColor))
          ],
        ),
      ],
    );
