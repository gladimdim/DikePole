...
public class InkList extends HashMap<InkListItem, Integer> {
	...
	public InkList(Entry<InkListItem, Integer> singleElement) {
	...
	public InkList intersect(InkList otherList) {
		...
		for (Entry<InkListItem, Integer> kv : this.entrySet()) {
	 ...
	 * ink.
	 */
	public Entry<InkListItem, Integer> getMaxItem() {
	 ...
	 * ink.
	 */
	public Entry<InkListItem, Integer> getMinItem() {
	...
	public boolean contains(InkList otherList) {
		for (Entry<InkListItem, Integer> kv : otherList.entrySet()) {
	...
	public String getSingleOriginListName() {
		...
		for (Entry<InkListItem, Integer> itemAndValue : entrySet()) {
	...
	public InkList getInverse() {
		...
		if (origins != null) {
			for (ListDefinition origin : origins) {
				for (Entry<InkListItem, Integer> itemAndValue : origin.getItems().entrySet()) {
	...
	public InkList getAll() {
		...
		if (origins != null) {
			for (ListDefinition origin : origins) {
				for (Entry<InkListItem, Integer> kv : origin.getItems().entrySet()) {
	...
	public boolean ContainsItemNamed(String itemName) {
		for (Entry<InkListItem, Integer> itemWithValue : this.entrySet()) {
	...
	public class CustomEntry implements Entry<InkListItem, Integer> {
		...
		public void set(Entry<InkListItem, Integer> e) {
			key = e.getKey();
			value = e.getValue();
		}
